...
// ...existing code...
export default function Story2024_5() {
    const { t, lang } = useTranslation()
    const content = t('stories.2024_5.content') || []
            ...
            <div className="col-12">
              <article className="story-article hero section_margin line_hoz">
                <header className="story-header">
                  <h1 className="tagline story_title">{t('stories.2024_5.title')}</h1>
                  <h6 className="story-subtitle">{t('stories.2024_5.subtitle')}</h6>
                  <div className="story-meta">{t('stories.2024_5.meta')}</div>
                </header>
