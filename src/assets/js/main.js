jQuery(function($) {
    ...
    function owlCarousel() {
        ...
        $('#slideshow_face').owlCarousel({
            ...
            smartSpeed: 450,
            loop: true,
            autoplay: false, // disable automatic advance
...
// Language switcher: simple client-side handler that remembers selection.
// Changes a couple of visible strings (logo and tagline) as an example.
(function($){
